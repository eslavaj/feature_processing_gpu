...
//            	matcher->knnMatchAsync( (dataBuffer.end() - 2)->gpu_descriptors, (dataBuffer.end() - 1)->gpu_descriptors, gknnMatches, 6, noArray(), istream);
...
///*
//                std::vector<cv::KeyPoint> kpoints_2, kpoints_1;
//                kpoints_2 = (dataBuffer.end() - 2)->keypoints;
//                kpoints_1 = (dataBuffer.end() - 1)->keypoints;
//
//                cv::KeyPointsFilter::retainBest(kpoints_2, 250);
//                cv::KeyPointsFilter::retainBest(kpoints_1, 250);
//
//                cv::drawMatches((dataBuffer.end() - 2)->cameraImg, kpoints_2,
//                                (dataBuffer.end() - 1)->cameraImg, kpoints_1,
//                                matches, matchImg,
